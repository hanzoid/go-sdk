...
func (c *Client) Enforce(permissionId string, modelId string, resourceId string, enforcerId string, owner string, authzRequest AuthzRequest) (bool, error) {
	postBytes, err := json.Marshal(authzRequest)
	if err != nil {
		return false, err
	}
...
func Enforce(permissionId string, modelId string, resourceId string, enforcerId string, owner string, authzRequest AuthzRequest) (bool, error) {
	return globalClient.Enforce(permissionId, modelId, resourceId, enforcerId, owner, authzRequest)
}

func (c *Client) BatchEnforce(permissionId string, modelId string, resourceId string, enforcerId string, owner string, authzRequests []AuthzRequest) ([][]bool, error) {
	postBytes, err := json.Marshal(authzRequests)
	if err != nil {
		return nil, err
	}
...
func BatchEnforce(permissionId string, modelId string, resourceId string, enforcerId string, owner string, authzRequests []AuthzRequest) ([][]bool, error) {
	return globalClient.BatchEnforce(permissionId, modelId, resourceId, enforcerId, owner, authzRequests)
}
